...
const Radio = () => {
  const stations = [
    { name: "Chill Beats FM", listeners: "24,523", category: "Lo-fi & Chill" },
    { name: "Classic Rock 101", listeners: "18,756", category: "Rock" },
    { name: "Hip-Hop Nation", listeners: "32,145", category: "Hip-Hop" },
    { name: "Jazz Café", listeners: "12,678", category: "Jazz" },
    { name: "Electric Avenue", listeners: "26,890", category: "Electronic" },
    { name: "Country Roads", listeners: "15,432", category: "Country" }
  ];
